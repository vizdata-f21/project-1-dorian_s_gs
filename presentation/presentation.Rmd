...
```{r density analysis, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 30, fig.height = 25, fig.align = "center"}
superbowl <- superbowl %>%
...
```{r interactions, echo = FALSE, warning = FALSE, fig.width = 35, fig.height = 30, fig.align = "center"}
superbowl %>%
